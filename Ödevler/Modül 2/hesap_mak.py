...
while True:
    ...
    *************************
    ...
    if islem == 1:
        ...
        print("{} x {} = {} ".format(a, b, carpma(a, b)))
    elif islem == 2:
        a = int(input("İlk sayı:"))
        b = int(input("İkinci sayı:"))
        print("{} / {} = {} ".format(a, b, bölme(a, b)))
    elif islem == 3:
        a = int(input("İlk sayı:"))
        b = int(input("İkinci sayı:"))
        ...
        a = int(input("İlk sayı:"))
        b = int(input("İkinci sayı:"))
        print("{} - {} = {} ".format(a, b, cıkarma(a, b)))
    elif islem == 5:
        a = int(input("Taban:"))
        b = int(input("Üs:"))
        print("{} ^ {} = {} ".format(a, b, us_alma(a, b)))
    elif islem == 6:
        ...
        print("{}! = {}".format(a, faktoriyel(a)))
    elif islem == 10:
        a = int(input("Karekökü alınacak sayıyı girin:"))
        print("{}^(0.5) = {}".format(a, karekok(a)))
    elif islem == "q":
        break
    else:
